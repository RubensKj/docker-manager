...
@Service
public class JavaDockerFilesService implements IDockerFileRepository {

    @Override
    public List<String> createDockerFileByType(Image image, Type type, List<String> defaultLinesDocker) {
